...
|---|---|---|---|---|
| PAM-EXP-01 — Rotina a dois | Vínculo ≥4, Clareza ≥4, Segurança ≥4, Tensão ≤1 | Etapa 1: perguntar o que “perto” significa; interlúdio: bebida escolhida; Etapa 2: procurar a presilha; Etapa 3: esperar sem punição; interlúdio: date de curiosidade; Etapa 5: check-in semanal. | **Rotina a dois**, com check-in e date revisável. | O jogo declara vitória romântica fixa, ignora Jessica ou não permite voltar ao mapa. |
